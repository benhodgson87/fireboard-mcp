    ...
    "list_sessions",
    {
      ...
      inputSchema: {
        limit: z
          ...
          .optional()
          .describe(
            "Maximum number of sessions to return. Default 20. Applied client-side.",
          ),
        in_progress_only: z
          .boolean()
          .optional()
          .describe(
            "If true, only return sessions currently in progress. Applied client-side.",
          ),
      },
    ...
    "get_session_chart",
    {
      ...
      inputSchema: {
        ...
        include_drive: z
          ...
          .optional()
          .describe(
            "Include FireBoard Drive % data as an additional channel. Default false.",
          ),
      },
